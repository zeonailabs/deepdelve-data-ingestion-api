...
# mcq indexing
MCQ_INDEXING_QUEUE = os.getenv("MCQ_INDEXING_QUEUE", "mcq_indexing_queue")
MESSAGE_CHUNKS = os.getenv("MESSAGE_CHUNKS", 200)
...
SECTION_LAMBDA_NAME = os.getenv("SECTION_LAMBDA_NAME", "section_splitter_lambda")
